...
const translations = {
    ko: {
        ...
        about: {
            ...
            scientific: {
                title: "🧬 과학적 근거",
                intro: "테토-에겐 성격 유형 테스트는 테스토스테론(Testosterone)과 에스트로겐(Estrogen) 호르몬의 영향에 기반한 성격 분석 도구입니다.",
                relationship: "호르몬과 성격의 관계",
                testosterone: "테스토스테론: 경쟁심, 리더십, 목표 지향성, 독립성과 연관",
                estrogen: "에스트로겐: 공감 능력, 협동심, 감정 표현, 관계 중심성과 연관",
    ...
    en: {
        ...
        about: {
            ...
            scientific: {
                ...
                intro: "The Teto-Egen personality type test is a personality analysis tool based on the influence of testosterone and estrogen hormones.",
                relationship: "Relationship between Hormones and Personality",
                testosterone: "Testosterone: Associated with competitiveness, leadership, goal orientation, and independence",
                estrogen: "Estrogen: Associated with empathy, cooperation, emotional expression, and relationship focus",
